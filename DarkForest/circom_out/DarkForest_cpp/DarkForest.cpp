...
void Jump_4_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Jump_4_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 118;}

uint get_number_of_components() {return 10;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 81;}
...
ctx->componentMemory[coffset].templateName = "Jump";
ctx->componentMemory[coffset].signalStart = soffset;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "less_than";
mySubcomponents[aux_create+i] = aux_cmp_num;
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 1],&signalValues[mySignalStart + 3]); // line circom 22
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 2],&signalValues[mySignalStart + 4]); // line circom 24
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 6],&signalValues[mySignalStart + 6]); // line circom 27
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 7],&signalValues[mySignalStart + 7]); // line circom 29
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 8],&signalValues[mySignalStart + 9]); // line circom 32
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 5]); // line circom 33
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "jump_atob";
mySubcomponents[aux_create+i] = aux_cmp_num;
Jump_4_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 50 ;
aux_cmp_num += 4;
}
}
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "jump_btoc";
mySubcomponents[aux_create+i] = aux_cmp_num;
Jump_4_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 50 ;
aux_cmp_num += 4;
...
PFrElement aux_dest = &signalValues[mySignalStart + 8];
// load src
Fr_sub(&expaux[2],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 7]); // line circom 55
Fr_mul(&expaux[0],&signalValues[mySignalStart + 2],&expaux[2]); // line circom 55
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 9];
// load src
Fr_sub(&expaux[2],&signalValues[mySignalStart + 7],&signalValues[mySignalStart + 3]); // line circom 58
Fr_mul(&expaux[0],&signalValues[mySignalStart + 4],&expaux[2]); // line circom 58
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[2],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 5]); // line circom 61
Fr_mul(&expaux[0],&signalValues[mySignalStart + 6],&expaux[2]); // line circom 61
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 8],&signalValues[mySignalStart + 9]); // line circom 62
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 10]); // line circom 62
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
// load src
Fr_sub(&expaux[0],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0]); // line circom 66
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_eq(&expaux[0],&signalValues[mySignalStart + 11],&circuitConstants[1]); // line circom 67
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 67. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
...
// need to run sub component
assert(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Jump_4_run(mySubcomponents[cmp_index_ref],ctx);
}
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0],&circuitConstants[1]); // line circom 76
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0],&circuitConstants[1]); // line circom 85
...
// load src
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0]); // line circom 90
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 12],&signalValues[mySignalStart + 13]); // line circom 92
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
